...
const examenCliniqueHematomeSchema = new Schema(
  {
    ...
    idNIHSS: {
      ...
      ref: "Nihss",
      default: null,
    }, // Store the reference to the Nihss document
...
examenCliniqueHematomeSchema.add(BaseTabSchema);
...
examenCliniqueHematomeSchema.pre("save", function (next) {
  ...
  Object.keys(this._doc).forEach((key) => {
    if (this[key] !== undefined && this[key] !== null && this[key] !== "") {
      //Keep booleans, numbers and strings.
...
const ExamenCliniqueHematome = mongoose.model(
  "ExamenCliniqueHematome",
  examenCliniqueHematomeSchema,
);
