...
const ConduiteTenirInitialeHematomeSchema = new Schema(
  {
    ...
    VoieAdministration: {
      type: String,
      enum: ["Voie veineuse", "Voie orale", null],
      default: null,
    },
    ReversionINR: {
      type: String,
    ...
    Hydratationparenterale: {
      type: String,
      enum: ["Oui", "Non", null],
      default: null,
    },
    AnticoagulationPreventive: {
      type: String,
      enum: ["Oui", "Non", null],
      default: null,
    },
...
const ConduiteTenirInitialeHematome = mongoose.model(
  "ConduiteTenirInitialeHematome",
  ConduiteTenirInitialeHematomeSchema,
);
