...
const conclusionSortieHematomeSchema = new Schema(
  {
    ...
    ModeSortie: {
      type: String,
      enum: ["A domicile", "Transfert dans un autre service", "Décés"],
      default: null,
    },
...
const ConclusionSortieHematome = mongoose.model(
  "ConclusionSortieHematome",
  conclusionSortieHematomeSchema,
);
